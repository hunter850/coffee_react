...
//import SingleMapDetail from "../../component/Food/components/GoogleMap/SingleMapDetail";
        ...
        <Fragment>
            ...
            <div className="StoreContainer">
                ...
                <div className="banner_photos">
                    <div className="banner_photos_part1">
                        ...
                        <div className="banner_session_02">
                            <p className="text_sec_01">關於城市裡的咖啡因</p>
                            <p className="text_sec_02">
                                “0+B ”於 2022
                    ...
                    <div className="banner_photos_part2">
                        <img
                            src={require("../../images/Coupon/bimg02-1.png")}
                            alt=""
                        />
                    </div>
                    <div className="banner_photos_part3">
                        <img
                ...
                <div className="quality_bg">
                    <div className="quality">
                        <div className="dsplay_flex_mm pt53">
                            <div>
                                {/* <img src="./imgs/Component 16.png" alt=""> */}
                                <img
                            ...
                            <div>
                                <p className="f24mt23">0+B的承諾</p>
                            </div>
                            <div className="quality_main">
                                <div className="quality_main_01">
                                    <div className="quality_main_01_a">
                                        <div>
                                            {/* <img src="./imgs/bg_tips_num_01 1.png" alt=""> */}
                                            <img
                                    ...
                                    <div className="quality_main_01_c">
                                        {/* <img src="./imgs/img_tips_05 1.png" alt=""> */}
                                        <img
                                ...
                                <div className="quality_main_01">
                                    <div className="quality_main_01_a">
                                        <div>
                                            {/* <img src="./imgs/bg_tips_num_02 1.png" alt=""> */}
                                            <img
                                    ...
                                    <div className="quality_main_01_c">
                                        {/* <img src="./imgs/img_tips_04 1.png" alt=""> */}
                                        <img
                                ...
                                <div className="quality_main_01">
                                    <div className="quality_main_01_a">
                                        <div>
                                            {/* <img src="./imgs/bg_tips_num_03 2.png" alt=""> */}
                                            <img
                                    ...
                                    <div className="quality_main_01_c">
                                        {/* <img src="./imgs/img_tips_01 1.png" alt=""> */}
                                        <img
                ...
                <div className="Store_bg store_time ">
                    <div className="store_time_inner dsplay_flex_mm"></div>
                </div>
